...
from util import save_checkpoint, quantile_accuracy, my_eval_with_dynamic_thresh, save_reg_checkpoint
from finetune_model import ft_1lead_ECGFounder, ft_1lead_ramdom, ft_1lead_ssl
from sklearn.model_selection import train_test_split
import torch.nn as nn
from net1d import Net1D
from torch.utils.data import Dataset, DataLoader
from dataset import LVEF_1lead_Dataset, CHD_1lead_Dataset, CKD_1lead_Dataset, age_1lead_Dataset, age_reg_1lead_Dataset, sex_1lead_Dataset, lab_reg_1lead_Dataset, LVEF_reg_1lead_Dataset
...
for run_id in datasets:
  for Model in Models:
    ...
    saved_dir = '/data1/1shared/lijun/ecg/anyECG/code/res/eval_all_1lead_reg_30epoch/{}'.format(run_id)
    print(saved_dir)
    print(df_label_path)

    if not os.path.exists(saved_dir):
        os.makedirs(saved_dir, exist_ok=True)
    copyfile('/data1/1shared/lijun/ecg/anyECG/code/MIMIC_finetune_1lead_template_reg.py', os.path.join(saved_dir, 'MIMIC_finetune_1lead_template_reg.py'))
